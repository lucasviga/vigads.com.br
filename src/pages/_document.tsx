    ...
    return (
      <Html>
        <Head>
          ...
          <meta
            property='og:title'
            content='Lucas Viga - Front-end Engineer Design'
          />
          <meta
          ...
          />
          <meta property='og:image' content='/images/cover-site.png' />
          <meta name='twitter:card' content='summary_large_image' />
          <meta property='twitter:domain' content='https://vigads.com.br/' />
          ...
          <meta
            ...
            content='I’ve been working as a developer for more than 2 years. During this time, I’ve been developing with theses techs: React JS/Native, Next JS, JS and TS, Chakra UI, Styled Components and more.'
          />
          <meta name='twitter:image' content='vigads' />
        </Head>
