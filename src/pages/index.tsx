      ...
      <Aboutme>
        ...
        <div className='bio'>
          <p>
            ...
            time, I’ve been developing with theses techs: React JS/Native, Next
            JS, JS and TS, Chakra UI, Styled Components and more.
          </p>
      ...
      <SummaryExperience>
        <div className='content'>
          <header>
            ...
            <h2>
              Theses are the technologies I’ve had experience creating
              applications:
            </h2>
          </header>
        </div>
